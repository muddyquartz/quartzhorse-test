...
charadex.site = {
  title: "Quartz Horse",
  url: "https://muddyquartz.github.io/quartzhorse-test/",
  description: `horses!`
}
...
charadex.sheet = {
  ...
  id: "1DpnX-Tog-WRWzN2YVrKIGhd3R0ytTei-0F_3BVOr4q0",
  ...
  options: {
    ...
    designTypes: ['All', 'Official Design', 'Guest Design', 'Custom Design'],
    statuses: ['All', 'Open for Offers', 'Registered','Deceased', 'Pending Trade'],
    rarity: ['All', 'Common', 'Uncommon', 'Rare', 'Very Rare', 'Legendary'],
    species: ['All', 'Quartz Horse'],
    itemTypes: ['All', 'Apple', 'Breeding Slot'],
    traitTypes: ['All', 'Base Coat','Coat Dilution','Marking','Mutation','Non-Genetic']
